...
【自检清单】— 输出前逐条核对，任何一条未通过必须修正：
□ 格式：每个镜头都有 visual/speakerAction/listenerReaction/physicalFeedback/sound 五个字段，无遗漏
□ 情绪逻辑：speakerAction 是否从角色情绪基线出发？已触发阶段是否出现了明显动作变化？
□ 视线衔接：相邻镜头之间视线是否有明确落点切换（不能两个镜头都"看向远方"）？
□ 具体性：所有动作都有明确指向（看谁/朝哪/伸手向什么），无无指向动作
□ 禁止项：没有直接写情绪词（生气/害怕/难过/紧张），只有物理动作
□ 长度：visual≥15字，speakerAction≥10字，physicalFeedback≥10字，sound≥10字
